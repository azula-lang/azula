...
Precedences = {
    ...
    Azula::TokenType::NOT_EQ => OperatorPrecedence::EQUALS,
    Azula::TokenType::LT => OperatorPrecedence::LESS_GREATER,
    Azula::TokenType::LT_EQ => OperatorPrecedence::LESS_GREATER,
    Azula::TokenType::GT => OperatorPrecedence::LESS_GREATER,
    Azula::TokenType::GT_EQ => OperatorPrecedence::LESS_GREATER,
